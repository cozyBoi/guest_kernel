...
#define __NR_syscall_max 333 /* sizeof(syscalls_64) - 1	# */
#define NR_syscalls 334 /* sizeof(syscalls_64)	# */
#define __NR_ia32_syscall_max 383 /* sizeof(syscalls_ia32) - 1	# */
#define IA32_NR_syscalls 384 /* sizeof(syscalls_ia32)	# */
...
#define KERNEL_IBRS_SPEC_CTRL_enabled 0 /* offsetof(struct kernel_ibrs_spec_ctrl, enabled)	# */
#define KERNEL_IBRS_SPEC_CTRL_entry 8 /* offsetof(struct kernel_ibrs_spec_ctrl, entry)	# */
#define KERNEL_IBRS_SPEC_CTRL_exit 4 /* offsetof(struct kernel_ibrs_spec_ctrl, exit)	# */
#define KERNEL_IBRS_SPEC_CTRL_hi32 12 /* offsetof(struct kernel_ibrs_spec_ctrl, hi32)	# */
