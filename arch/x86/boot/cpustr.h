static const char x86_cap_strs[] =
	...
	"\x07\x0a""sme\0"
#endif
#if REQUIRED_MASK7 & (1 << 13)
	"\x07\x0d""retpoline_amd\0"
#endif
	...
	"\x07\x12""mba\0"
#endif
#if REQUIRED_MASK7 & (1 << 21)
	"\x07\x15""ibp_disable\0"
#endif
	...
	"\x12\x12""pconfig\0"
#endif
#if REQUIRED_MASK18 & (1 << 26)
	"\x12\x1a""spec_ctrl\0"
#endif
#if REQUIRED_MASK18 & (1 << 27)
	"\x12\x1b""intel_stibp\0"
#endif
